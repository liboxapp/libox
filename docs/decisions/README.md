...
| [Z.6](Z6-stack-tecnologico.md) | Stack tecnológico — Next.js para todo (descarta Astro); Drizzle + Supabase (Auth y DB host) + Inngest cerrados con [benchmark](../benchmark-stack.md) | Cerrada en dirección; todas las sub-decisiones resueltas | 2026-08-03 |
