...
tags: [sortibox, decision, custodia, pagos, compliance]
decided: 2026-06-05
relates: [docs/compliance-peru.md, docs/plans/sortibox-plan.md]
updated: 2026-06-05
---
...
**Documento canónico**: este archivo. Hay un mirror en [`docs/plans/sortibox-plan.md`](../plans/sortibox-plan.md#z1--custodia-del-dinero-cerrada-el-2026-06-05) (Anexo Z.1); ante divergencia, este archivo manda.
...
Sortibox opera el MVP-1 bajo **Modelo C — escrow conceptual**:
...
3. **Migración futura a escrow real (B) requiere reescribir contabilidad**: si más adelante Sortibox justifica operar como custodio, no tiene el modelo contable ya validado. Es deuda técnica diferida.
...
C es además el único modelo que preserva la intención arquitectónica del PRD ALAZAR v11 (settlement gates, audit-first, ledger bank-grade) sin forzar al MVP a un modelo regulatorio inviable.
...
## Implicaciones sobre el PRD ALAZAR v11
...
1. **[ABOGADO]** ¿Operar un marketplace de rifas con boleto pagado bajo organizador RUC califica a Sortibox como **sujeto obligado UIF-Perú** independientemente del modelo de custodia? Define si Sortibox necesita oficial de cumplimiento PLAFT y manual desde día 1, sin importar A, B o C.
